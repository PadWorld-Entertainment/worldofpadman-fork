...
fireExplosion
{
	cull disable
	{
		animmap 8 gfx/damage/bettyboom_1.tga gfx/damage/bettyboom_2.tga gfx/damage/bettyboom_3.tga gfx/damage/bettyboom_4.tga gfx/damage/bettyboom_5.tga gfx/damage/bettyboom_6.tga gfx/damage/bettyboom_7.tga gfx/damage/bettyboom_8.tga
		rgbGen wave inversesawtooth 0 1 0 8
		blendfunc add
	}
	{
		animmap 8 gfx/damage/bettyboom_2.tga gfx/damage/bettyboom_3.tga gfx/damage/bettyboom_4.tga gfx/damage/bettyboom_5.tga gfx/damage/bettyboom_6.tga gfx/damage/bettyboom_7.tga gfx/damage/bettyboom_8.tga gfx/damage/black.tga
...
gumMark
{
	...
	polygonOffset
	{
		map models/weaponsfx/gummark.tga
		blendfunc blend
		rgbGen vertex
		alphaGen vertex
	}
