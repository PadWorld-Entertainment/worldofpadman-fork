...
void AssetCache( void ) {
	...
	uiInfo.newHighScoreSound = trap_S_RegisterSound("sound/feedback/voc_newhighscore", qfalse);
}
...
void _UI_Init( qboolean inGameLoad ) {
  ...
  uiInfo.aliasCount = 0;
	...
	if (trap_Cvar_VariableValue("ui_TeamArenaFirstRun") == 0) {
		trap_Cvar_Set("s_volume", "0.5");
		trap_Cvar_Set("s_musicvolume", "0.2");
...
static cvarTable_t		cvarTable[] = {
	...
	{ &ui_teamName, "ui_teamName", "BlueNoses", CVAR_ARCHIVE },
	{ &ui_opponentName, "ui_opponentName", "RedPads", CVAR_ARCHIVE },
	{ &ui_redteam, "ui_redteam", "RedPads", CVAR_ARCHIVE },
	{ &ui_blueteam, "ui_blueteam", "BlueNoses", CVAR_ARCHIVE },
